...
| `tests/automation_game_playthrough.rs` | Full-game playthroughs via AutomationHarness: checkmate, save/load, promotion, draw claim, rematch, stalemate, recovery | Adding game-level automation scenarios or debugging full-stack flow regressions |
